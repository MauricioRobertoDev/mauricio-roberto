...
export type TechLinkProps = { icon: keyof typeof Icons; text: string; href?: string };

export function TechLink({ icon, text, href }: TechLinkProps) {
    ...
    return (
        ...
        >
            ...
            <span className="pl-2 ml-2 border-l border-muted-foreground/40">{text}</span>
            {href && (
